...
std::string read_lineitem(std::ifstream& lineitem, size_t num_rows) {
    std::cout << "Reading lineitem" << std::endl;
    ...
    return "INSERT INTO Lineitem VALUES " + accum + ";";
}
...
void init_tables(sgx_enclave_id_t eid) {
    ...
    ret =  ecall_execute_sql(eid,
        "INSERT INTO Lineitem VALUES"
            "(1, 1, 1, 17, 17954.55, 0.10, 0.02, 'N', 'O', '1992-03-13'),"
            "(1, 2, 2, 21, 34850.16, 0.05, 0.06, 'N', 'O', '1994-04-12'),"
            "(2, 3, 3, 8, 7712.48, 0.06, 0.02, 'A', 'F', '1996-02-28'),"
            "(3, 4, 4, 5, 25284.00, 0.06, 0.06, 'A', 'F', '1994-12-31');"
    );
    if (ret != SGX_SUCCESS) {
        cerr << "Error: Making an ecall_execute_sql()" << endl;
        return;
